    ...
    <>
      ...
      <div>
        ...
        <div className="flex md:flex-row flex-col">
          ...
          <div className="flex flex-col md:self-end md:pl-8 py-3 md:py-0 max-w-none xl:col-span-2">
            <div className="font-bold pb-2 md:pb-3 text-2xl md:text-3xl text-gray-900 dark:text-white">
              강차곡
            </div>
            <div className="font-semibold pb-1 text-xl md:text-2xl text-gray-600 dark:text-gray-300">
              다재다능한 마케터
            </div>
        ...
        <h1 className="text-2xl pt-8 md:text-3xl font-bold leading-8 md:leading-10 tracking-tight text-gray-900 dark:text-gray-100">
          사용 가능한 툴
        </h1>
